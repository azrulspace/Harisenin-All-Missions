    ...
    <section className="relative w-full min-h-screen bg-[#f6f6f8] overflow-hidden flex flex-col items-center pt-[150px] lg:pt-[200px]">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden flex justify-center">
        ...
        <div className="absolute bottom-[-100px] w-full max-w-[1512px] h-[520px] opacity-45 blur-[60px]" style={{
          backgroundImage: `
            url("data:image/svg+xml;utf8,<svg viewBox='0 0 1512 520' xmlns='http://www.w3.org/2000/svg' preserveAspectRatio='none'><rect x='0' y='0' height='100%' width='100%' fill='url(%23grad1)' opacity='1'/><defs><radialGradient id='grad1' gradientUnits='userSpaceOnUse' cx='0' cy='0' r='10' gradientTransform='matrix(1.23 -48.4 -105.55 -2.6824 214.5 172)'><stop stop-color='rgba(246,195,48,0.45)' offset='0'/><stop stop-color='rgba(246,195,48,0)' offset='0.7'/></radialGradient></defs></svg>"), 
            url("data:image/svg+xml;utf8,<svg viewBox='0 0 1512 520' xmlns='http://www.w3.org/2000/svg' preserveAspectRatio='none'><rect x='0' y='0' height='100%' width='100%' fill='url(%23grad2)' opacity='1'/><defs><radialGradient id='grad2' gradientUnits='userSpaceOnUse' cx='0' cy='0' r='10' gradientTransform='matrix(0 -39 -83.16 0 831.6 52)'><stop stop-color='rgba(117,2,206,0.45),0.45)' offset='0'/><stop stop-color='rgba(117,2,206,0)' offset='0.7'/></radialGradient></defs></svg>"), 
            url("data:image/svg+xml;utf8,<svg viewBox='0 0 1512 520' xmlns='http://www.w3.org/2000/svg' preserveAspectRatio='none'><rect x='0' y='0' height='100%' width='100%' fill='url(%23grad3)' opacity='1'/><defs><radialGradient id='grad3' gradientUnits='userSpaceOnUse' cx='0' cy='0' r='10' gradientTransform='matrix(0 -44.2 -90.72 0 1209.6 156)'><stop stop-color='rgba(3,127,237,0.45)' offset='0'/><stop stop-color='rgba(3,127,237,0)' offset='0.7'/></radialGradient></defs></svg>"), 
            url("data:image/svg+xml;utf8,<svg viewBox='0 0 1512 520' xmlns='http://www.w3.org/2000/svg' preserveAspectRatio='none'><rect x='0' y='0' height='100%' width='100%' fill='url(%23grad4)' opacity='1'/><defs><radialGradient id='grad4' gradientUnits='userSpaceOnUse' cx='0' cy='0' r='10' gradientTransform='matrix(0 -36.4 -68.04 0 1436.4 390)'><stop stop-color='rgba(85,233,209,0.55)' offset='0'/><stop stop-color='rgba(85,233,209,0)' offset='0.7'/></radialGradient></defs></svg>")
          `
        }} />
