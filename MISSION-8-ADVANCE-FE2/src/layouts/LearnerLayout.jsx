...
const LearnerLayout = ({ children }) => {
  ...
  const learnerName = localStorage.getItem('user_name') || 'Hazrul Aswad';
  
  // Extract initials for the avatar (e.g., "Hazrul Aswad" -> "HA")
      ...
      <aside className="w-[260px] bg-white border-r border-gray-100 flex flex-col justify-between shrink-0 h-full relative z-20">
        ...
        <div className="p-4 border-t border-gray-100">
          <button 
            ...
            className="w-full flex items-center gap-3 text-gray-500 hover:bg-red-50 hover:text-red-600 p-3 rounded-xl transition-colors font-medium"
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <header className="h-[80px] bg-white border-b border-gray-100 px-8 flex items-center justify-end shrink-0">
          <div className="flex items-center gap-4">
            <div className="text-right">
              <p className="text-sm font-bold text-gray-900 leading-tight">{learnerName}</p>
              <p className="text-xs text-gray-400 mt-0.5 font-medium">Learner</p>
            </div>
