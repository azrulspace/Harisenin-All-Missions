      ...
      <div className="bg-white rounded-[24px] max-w-[480px] w-full p-8 shadow-2xl relative animate-fade-in">
        ...
        <div className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 text-center">
            Mulai belajar desain & AI
          </h2>
          <p className="text-sm text-gray-500 text-center mt-1">
            Buat akun gratis untuk mengakses katalog kelas DKV.
          </p>
        </div>
        ...
        <button 
          ...
          disabled={isLoading}
          className="border border-gray-200 rounded-xl py-3 px-4 flex items-center justify-center gap-3 font-medium text-sm text-gray-700 hover:bg-gray-50 transition-colors w-full mb-6 disabled:opacity-50"
        >
